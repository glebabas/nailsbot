...
export const SlotSelector: React.FC<SlotSelectorProps> = ({
  ...
  return (
    <div className="pb-32 max-w-md mx-auto px-4 pt-3 space-y-5">
      ...
      {timing && (
        <div className="bg-stone-900 text-white p-3.5 rounded-2xl shadow-sm space-y-1.5">
          <div className="flex items-center justify-between text-xs">
            <span className="text-stone-300">Расчетное время работы:</span>
          ...
          <div className="flex items-center justify-between text-xs">
            ...
            <span className="text-emerald-400 font-medium">+15 мин</span>
          </div>
          <div className="pt-1 border-t border-stone-800 flex items-center justify-between text-xs font-semibold">
            <span>Необходимое окно мастера:</span>
